<?php
get_header();
// Extract the part after /portfolio
$request_uri = $_SERVER['REQUEST_URI'];
$segments = explode('/', trim($request_uri, '/'));
$client = isset($segments[1]) ? $segments[1] : ''; // Get the part after /portfolio

// Ensure no additional slashes are present
if (strpos($client, '/') !== false) {
    $client = ''; // Reset if invalid
}
